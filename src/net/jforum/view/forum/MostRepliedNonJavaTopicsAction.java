...
public class MostRepliedNonJavaTopicsAction extends Command {
	...
	List topics()
	{
		...
		List mostViewedTopics = new GenericTopicDAO().selectMostRepliedNotFromForums(idsExcludedFromSearch, QUERY_LIMIT);
